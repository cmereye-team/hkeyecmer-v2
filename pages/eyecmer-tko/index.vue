        ...
        <div class="textimgbox">
          <ul class="contentbox">
            ...
            <li>
              ...
              >將軍澳運亨路1號新都城中心一期地下55-56號鋪<br />寶琳站B2出口（出站後右轉）
            </li>
            ...
            <li>
              ...
              >以下公共交通線路會停靠新都城中心一期附近：<br />
              巴士：789、98D<br />
              小巴：105、10M<br />
              地鐵：將軍澳綫 寶琳站 ( 溫馨提示：輪椅人士請使用寶琳站A出口，<br />有行人天橋直達診所。)
            </li>
            <div class="mt-4">
              <div class="mt-4">
                <a
                  href="https://goo.gl/maps/j1EU4P37ciAG7EHp7"
                  target="_blank"
                  class="ui-link"
                  ><span
