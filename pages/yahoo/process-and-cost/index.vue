...
const serviceNavigation = [
  {
    ...
    anchorLink: '/yahoo/process-and-cost#cost',
  },
  {
    anchorName: 'pages.process_cost.process',
    anchorLink: '/yahoo/process-and-cost#processed',
  },
]
            ...
            <div class="content relative">
              ...
              <div class="processed-in pcpocessBox">
                <div class="lists">
                  <div
                    class="lists-in"
                    v-for="(processedItem, processedIndex) in processedLists"
                    :key="processedIndex"
                  >
                    <img
                      :src="processedItem.img"
                      :alt="processedItem.img_alt"
                      :title="processedItem.img_title"
                    />
                    <div class="name">
                      <span
