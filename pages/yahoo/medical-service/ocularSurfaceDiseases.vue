...
const serviceNavigation = [
  {
    ...
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#pterygium',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name2',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#blepharitis',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name3',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#keratitis',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name4',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#iritis',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name5',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#episcleritis',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name6',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#damage',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name7',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#keratoconus',
  },
  {
    anchorName:
      'pages.medical_service.ocularSurfaceDiseases_con.navLists.name8',
    anchorLink: '/yahoo/medical-service/ocularSurfaceDiseases#keratoplasty',
  },
]
// 常見問題
const meetArr = [
