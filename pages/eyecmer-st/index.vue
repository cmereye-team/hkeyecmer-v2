        ...
        <div class="textimgbox">
          <ul class="contentbox">
            ...
            <li>
              ...
              >沙田正街11-17號偉華中心2樓5A,5B及1C-1E號鋪（沙田站A出口）
            </li>
            ...
            <li>
              ...
              >以下公共交通線路會停靠偉華中心附近：<br />
              巴士：280X、403P、49X、81、88X<br />
              地鐵：東鐵綫、屯馬綫 沙田站
            </li>
            <div class="mt-4">
              <div class="mt-4">
          ...
          <!-- <img
            src="https://statichk.cmermedical.com/hkcmereye/ST/StAdress.avif"
          /> -->
          <!-- <div class="imgBox">
            <swiper
              :loop="true"
...
const clinicSlides = [
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/ST/StBg1.avif',
    alt: 'TwBg1',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/ST/StBg2.avif',
    alt: 'TwBg2',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/ST/StBg3.avif',
    alt: 'TwBg3',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/ST/StBg4.avif',
    alt: 'TwBg4',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/ST/StBg5.avif',
    alt: 'TwBg5',
  },
]
