...
const goVision = () => {
  location.href =
    'https://api.whatsapp.com/send?phone=85269180511&text=你好,我想查詢'
}
const bannerData = {
  pcSrc:
...
<template>
  <div>
    ...
    <div
      class="medicalOptometry_nav"
      :class="{ 'medicalOptometryNav-en': locale === 'en' }"
    >
      <div id="brief_introduction">
        <div>
          <div class="medicalOptometry_text_p_span">
            ...
            <p>
              ...
              <span style="cursor: pointer" @click="toCmer">{{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span1'
                )
              }}</span
              >{{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span2'
                )
              }}
              <span>{{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span3'
                )
              }}</span>
              {{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span4'
                )
              }}
              <span>{{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span5'
                )
              }}</span>
              {{
                $t(
                  'pages.medical_service.medicalOptometry_con.introduction.span6'
                )
              }}
            </p>
          </div>
          <div>
            <img
              ...
              :alt="
                locale === 'en'
                  ? 'Boy undergoing vision test for myopia control'
                  : '男童進行視力檢查以控制近視'
              "
            />
          </div>
        ...
        <div @click="toVision">
          <div>
            {{
              $t('pages.medical_service.medicalOptometry_con.introduction.btn1')
            }}
          </div>
          <div>
            {{
              $t('pages.medical_service.medicalOptometry_con.introduction.btn2')
            }}
          </div>
        </div>
      </div>
      <div id="cause">
        <div>
          {{ $t('pages.medical_service.medicalOptometry_con.cause.name') }}
        </div>
        <div>
          <div>
            <div>
              <img
                ...
                :alt="
                  locale === 'en'
                    ? 'Girl receiving eye exam services for eye health'
                    : '女童透過驗眼服務進行眼睛檢查'
                "
                srcset=""
              />
            ...
            <div>
              <div>
                {{
                  $t('pages.medical_service.medicalOptometry_con.cause.title1')
                }}
              </div>
              <div class="medicalOptometry_text_p_span">
                {{
              ...
              <div
                class="medicalOptometry_btn_bg"
                :class="{ 'Btn-en': locale === 'en' }"
                @click="toVision"
              >
                <div>
                  {{
                    $t('pages.medical_service.medicalOptometry_con.cause.text1')
                  }}
                </div>
                <div>
                  {{
                    $t('pages.medical_service.medicalOptometry_con.cause.btn1')
                  }}
                </div>
              </div>
            </div>
          ...
          <div>
            <div>
              <img
                ...
                :alt="
                  locale === 'en'
                    ? 'Girl with glasses maintaining eye health after an eye checkup'
                    : '戴眼鏡的男童已接受眼睛檢查以確保眼睛健康'
                "
                srcset=""
              />
            </div>
            <div>
              <div>
                {{
                  $t('pages.medical_service.medicalOptometry_con.cause.title2')
                }}
              </div>
              <div class="medicalOptometry_text_p_span">
                {{
              ...
              >
                <div>
                  {{
                    $t('pages.medical_service.medicalOptometry_con.cause.text2')
                  }}
                </div>
                <div>
                  {{
                    $t('pages.medical_service.medicalOptometry_con.cause.btn2')
                  }}
                </div>
              </div>
            </div>
          ...
          <div>
            <div>
              <img
                ...
                :alt="
                  locale === 'en'
                    ? 'Family of three doing eye exercises for better eye health'
                    : '一家三口做眼保健操以確保眼睛健康'
                "
                srcset=""
              />
            ...
            <div class="page-newNavs">
              <div class="page-newNavs-in">
                ...
                >
                  <img
                    ...
                    :alt="
                      locale === 'en'
                        ? 'CMER Vision Center offering Ortho-K lens services'
                        : '希瑪視光中心提拱角膜矯形術服務'
                    "
                  />
                </a>
              ...
              <div class="page-newNavs-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? 'CMER Vision Center providing myopia control contact lenses'
                      : '希瑪視光中心提供近視控制的隱形眼鏡產品服務'
                  "
                />
                <div class="page-newNavs-in-hover">
                  <div>
                    ...
                    <a
                      class="textLink"
                      href="https://www.cmervision.com/misight/"
                      >了解更多</a
                    >
                  </div>
                  <div>
              ...
              <div class="page-newNavs-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? `MER Vision Center offering children's myopia control lenses`
                      : '希瑪視光中心提拱兒童近視控制鏡片產品服務'
                  "
                />
                <div class="page-newNavs-in-hover page-newNavs-in-hover-2">
                  <div>
                    ...
                    <a
                      class="textLink"
                      href="https://www.cmervision.com/myopia-control-lenses/zeiss-myovision-pro/"
                      >了解更多</a
                    >
                  </div>
                  <div>
                    ...
                    <a
                      class="textLink"
                      href="https://www.cmervision.com/dims-soft-lens/"
                      >了解更多</a
                    >
                  </div>
                </div>
              ...
              <div class="page-newNavs-in">
                ...
                >
                  <img
                    ...
                    :alt="
                      locale === 'en'
                        ? 'CMER Vision Center providing atropine eye drops for myopia management'
                        : '希瑪視光中心提拱阿托品眼藥水產品服務'
                    "
                /></a>
              </div>
            ...
            <div class="contentbtn">
              ...
              >
                <div>
                  {{
                    $t(
                      'pages.medical_service.medicalOptometry_con.cause.btn3_1'
                    )
                  }}
                </div>
                <div>
                  {{
                    $t(
                      'pages.medical_service.medicalOptometry_con.cause.btn3_2'
                    )
                  }}
                </div>
              </div>
          ...
          <div>
            <div>
              <img
                ...
                :alt="
                  locale === 'en'
                    ? 'Ophthalmologist conducting an eye exam for seniors'
                    : '眼科醫生為年長者進行眼睛檢查'
                "
              />
            </div>
            <div>
              <div>
                {{
                  $t('pages.medical_service.medicalOptometry_con.cause.title4')
                }}
              </div>
              <div class="medicalOptometry_text_p_span">
                {{
          ...
          <div>
            <div>
              <img
                ...
                :alt="
                  locale === 'en'
                    ? 'Schedule regular eye exams to prevent eye diseases'
                    : '定期安排眼睛檢查以預防眼睛疾病'
                "
              />
            </div>
            <div>
              <div>
                {{
                  $t('pages.medical_service.medicalOptometry_con.cause.title5')
                }}
              </div>
              <div class="medicalOptometry_text_p_span">
                {{
            ...
            <div class="page-newNavs2">
              <div class="page-newNavs2-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? 'CMER Vision Center offering a variety of contact lenses'
                      : '希瑪視光中心提供隱形眼鏡產品服務'
                  "
                />
                <p>隱形眼鏡驗配</p>
                <a
                  href="https://www.cmervision.com/comprehensive/contact-lens-fitting/"
                  >了解更多</a
                >
              </div>
              <div class="page-newNavs2-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? 'CMER Vision Center providing progressive glasses for presbyopia'
                      : '希瑪視光中心提供漸進老花鏡產品服務'
                  "
                />
                <p>老花漸進鏡驗配</p>
                <a href="https://www.cmervision.com/progressive-lens/"
                  >了解更多</a
                >
              </div>
              <div class="page-newNavs2-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? 'CMER Vision Center offering contact lenses for presbyopia'
                      : '希瑪視光中心提供老花隱形眼鏡產品服務'
                  "
                />
                <p>老花隱形眼鏡驗配</p>
                <a
                  href="https://www.cmervision.com/comprehensive/contact-lens-fitting/multifocal-contact-lenses-fitting/"
                  >了解更多</a
                >
              </div>
              <div class="page-newNavs2-in">
                <img
                  ...
                  :alt="
                    locale === 'en'
                      ? 'CMER Vision Center providing rigid contact lenses for vision correction'
                      : '希瑪視光中心提供硬式隱形眼鏡產品服務'
                  "
                />
                <p>硬式隱形眼鏡驗配</p>
                <a
                  href="https://www.cmervision.com/comprehensive/contact-lens-fitting/rgp/"
                  >了解更多</a
                >
              </div>
            </div>
