      ...
      <div class="container">
        ...
        <div class="textimgbox">
          <ul class="contentbox">
            ...
            <li><i class="fa-1x fa fa-home"></i>畢打街1-3號中建大廈1515室</li>

            <li class="d-flex">
              <i class="fa-1x fa fa-calendar pr-2"></i> 星期一至五：09:30—13:30
              / 14:30—19:00 <br />
              星期六：09:30—18:00 <br />（星期日及公眾假期休息）
            </li>
            ...
            <div class="mt-4">
              <div class="mt-4">
                <a
                  href="https://goo.gl/maps/8GnSZHx69s4PgPif6"
                  target="_blank"
                  class="ui-link"
                  ><span
        ...
        <div class="textimgbox">
          <ul class="contentbox">
            ...
            <li><i class="fa-1x fa fa-home"></i>皇后大道中33號萬邦行1908室</li>

            <li class="d-flex">
              <i class="fa-1x fa fa-calendar pr-2"></i> 星期一至五：10:00—13:00
              / 15:00—18:00 <br />
              （星期六、星期日及公眾假期休息））
            </li>
            ...
            <div class="mt-4">
              <div class="mt-4">
                <a
                  href="https://goo.gl/maps/cTtPrK89qYcgNVcT8"
                  target="_blank"
                  class="ui-link"
                  ><span
                    ><button class="menuButton">Google地圖</button>
...
const clinicSlides = [
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/01.avif',
    alt: 'TwBg1',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/02.avif',
    alt: 'TwBg2',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/03.avif',
    alt: 'TwBg3',
  },
]
const clinicSlidesTwo = [
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/04.avif',
    alt: 'TwBg1',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/05.avif',
    alt: 'TwBg2',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/zhAd/06.avif',
    alt: 'TwBg3',
  },
]
