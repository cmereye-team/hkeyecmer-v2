...
const serviceLists = [
  {
    ...
    alt: 'Close-up of an eye illustration with Cataract',
  },
  {
    i: '02',
    imgUrl:
    ...
    alt: 'Fundus image showing Macular Degeneration',
  },
  {
    i: '04',
    imgUrl:
    ...
    alt: 'Illustration of Retinal Detachment',
  },
  {
    i: '05',
    imgUrl:
    ...
    alt: 'Close-up of an eye illustration with with Glaucoma',
  },
  {
    i: '08',
    imgUrl:
    ...
    alt: 'Close-up of an eye illustration with Ocular Surface and Corneal Diseases',
  },
  {
    i: '09',
    imgUrl:
    ...
    alt: 'Close-up of an eye illustration with Amblyopia and Strabismus',
  },
  {
    i: '11',
    imgUrl:
    ...
    alt: 'Close-up of an eye illustration with Eye Plastic Surgery and Orbital Diseases',
  },
  {
    i: '12',
    imgUrl:
    ...
    alt: 'Ophthalmic Equipment used during a Comprehensive Eye Exam for Myopia Control',
  },
  {
    i: '13',
    imgUrl:
    ...
    alt: 'Advanced Laser Technology used in LASIK and SMILE Eye Surgery',
  },
]
const pageNav = ref([
  {
  ...
  <div class="homePage">
    <div class="mbHomeSwiper">
      ...
      >
        <swiper-slide
          class="slideBox"
          v-for="(swiperItem, swiperIndex) in homeSwiperImgs"
          :key="swiperIndex"
        >
          <nuxt-link :to="swiperItem.link"
            ><img
              :src="locale === 'en' ? swiperItem.enimg : swiperItem.hkimg"
              :alt="swiperItem.title[0]"
          /></nuxt-link>
        </swiper-slide>
      </swiper>
    </div>
