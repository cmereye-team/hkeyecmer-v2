    ...
    <div class="home-mbContent">
      ...
      <div class="homePage-pageNav">
        ...
        >
          ...
          <span>
            <!-- prettier-ignore -->
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none"><circle cx="9.971" cy="9.468" r="9.408" fill="#2958a3"/><path d="M4.93 8.97a.498.498 0 0 0 0 .996zm9.425.85a.5.5 0 0 0 0-.705l-3.17-3.17a.498.498 0 0 0-.704.705L13.3 9.468l-2.818 2.817a.498.498 0 0 0 .704.704zm-9.424.146h9.072V8.97H4.93z" fill="#fff"/></svg>
          </span>
        </nuxt-link>
      </div>
