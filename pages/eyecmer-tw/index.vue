      ...
      <div class="container">
        ...
        <div class="textimgbox">
          <ul class="contentbox">
            ...
            <li><i class="fa-1x fa fa-home"></i>沙咀道255號思源樓地下</li>
            ...
            <!-- <li><i class="fa-1x fa fa-envelope-o"></i> <a href="mailto:booking@hkcmer.com">booking@hkcmer.com</a> -->
            <!-- </li> -->

            <li>
              <i class="fa-1x fa fa-subway"></i
              >以下公共交通線路會停靠沙咀道思源樓附近：<br />
              巴士：33B、481A、481B、49X、73X<br />
              地鐵：屯馬綫 荃灣西站、荃灣綫 荃灣站<br />
              渡輪：珀麗灣 - 荃灣
            </li>
            <div class="mt-4">
              <div class="mt-4">
          ...
          <!-- <img
            src="https://statichk.cmermedical.com/hkcmereye/TW/TwAdress.avif"
          /> -->
          <!-- <div class="imgBox">
            <swiper
              :loop="true"
...
const clinicSlides = [
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/TW/TwBg1.avif',
    alt: 'TwBg1',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/TW/TwBg2.avif',
    alt: 'TwBg2',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/TW/TwBg3.avif',
    alt: 'TwBg3',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/TW/TwBg4.avif',
    alt: 'TwBg4',
  },
  {
    image: 'https://statichk.cmermedical.com/hkcmereye/TW/TwBg5.avif',
    alt: 'TwBg5',
  },
]
