...
var list = [
  {
    ...
    title: '調節功能測試',
    questions: [
      '1/9. 看書、作業或用電腦時，注意力很難集中嗎？',
      '2/9. 看書、玩手機或用電腦時，很快就感覺眼睛疲勞嗎？',
      '3/9. 您的視力經常會起伏波動嗎？',
      '4/9. 平常會出現視力模糊或者重影嗎？',
      '5/9. 您的額頭出現過疼痛嗎？',
      '6/9. 您的眼睛出現過疼痛嗎？',
      '7/9. 您的眼睛裏面經常有紅血絲嗎？',
      '8/9. 長時間工作後，您的視力會突然下降嗎？',
      '9/9. 您會在沒有特殊原因的情況下，莫名流淚嗎？',
    ],
  },
  {
    id: '07',
    ...
    questions: [
      ...
      '2/9. 您的眼睛出現過疼痛嗎？',
      '3/9. 您眼睛裏有灼熱或灼燒的感覺嗎？',
      '4/9. 您的眼睛面對風、電腦螢幕或加熱器時很敏感嗎？',
      '5/9. 您的眼睛非常怕光嗎？',
      '6/9. 您經常通過用力眨眼來舒緩眼睛嗎？',
      '7/9. 您感覺眼睛裏面有異物嗎？',
      '8/9. 您感覺眼睛非常幹澀，不濕潤嗎？',
      '9/9. 看書、玩手機或用電腦時，很快就感覺眼睛疲勞嗎？',
    ],
  },
  {
    id: '08',
    ...
    questions: [
      '1/9. 您超過50歲了嗎？',
      '2/9. 您看遠處是不是沒有以前更清楚了？',
      '3/9. 您閱讀的時候是不是需要更亮的燈光？',
      '4/9. 你看東西時是不是顏色比以前暗淡或者發黃？',
      '5/9. 您有沒有出現視力模糊？',
      '6/9. 您有一只眼睛或兩只眼睛都出現複視嗎？',
      '7/9. 您有親屬得過白內障的嗎？',
      '8/9. 您的玻璃體上出現一點混濁了嗎？',
      '9/9. 您看向燈光的時候，周圍出現光暈嗎？',
    ],
  },
]
...
const handleBtn = (_num: number) => {
  ...
  if (acQuestions.value < qaData.questions.length - 1) {
    ...
    location.href =
      '/vision-health-test/result?id=' + testId + '&sum=' + sumNum.value
  }
}
