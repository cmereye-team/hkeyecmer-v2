        ...
        <defs>
          <clipPath id="clip0_5734_738">
            <rect
              ...
              height="52"
              fill="white"
              transform="translate(0.933594 15.6182) rotate(-20.4697)"
            />
          </clipPath>
        </defs>
      </svg>
...
.service-button {
  ...
  position: relative;
  &-in {
    filter: drop-shadow(0px 4px 3px rgba($color: #000000, $alpha: 0.5));
    -webkit-filter: drop-shadow(0px 4px 3px rgba($color: #000000, $alpha: 0.5));
    overflow: hidden;
    border-radius: 100px;
    ...
    &:hover {
      ...
      .service-button-in-text {
        box-shadow: 0px 4px 3px rgba($color: #000000, $alpha: 0.3) inset;
        span {
  ...
  &-svg {
    ...
    // opacity: 0;
    transition: all 0.3s;
    animation: iconNima 0.75s infinite linear alternate;
  }
  &.service-button-en {
    .service-button-in {
      &-text {
